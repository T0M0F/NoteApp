    ...
    List<Widget> widgets = [
      Container(
          ...
          child: DrawerHeader(
            child: Row(
              children: <Widget>[
                Text(
                  AppLocalizations.of(context).translate('boostnote') + ' ', 
     ...
     ListTile(
            leading: Icon(
              ...
              size: 21, 
              color: _pageNavigator.pageNavigatorState == PageNavigatorState.ALL_NOTES 
                ? Theme.of(context).accentColor 
                : Theme.of(context).buttonColor
            ),
            title: Text(
              AppLocalizations.of(context).translate('all_notes'), 
              style: TextStyle(color: _pageNavigator.pageNavigatorState == PageNavigatorState.ALL_NOTES 
                ? Theme.of(context).accentColor 
      ...
      ListTile(
        leading: Icon(
          Icons.folder, 
          color:  _pageNavigator.pageNavigatorState == PageNavigatorState.FOLDERS || _pageNavigator.pageNavigatorState == PageNavigatorState.NOTES_IN_FOLDER 
            ? Theme.of(context).accentColor 
            : Theme.of(context).buttonColor
        ),
        title: Text(
      ...
      ListTile(
        leading: Icon(
          ...
          color:  _pageNavigator.pageNavigatorState == PageNavigatorState.TAGS || _pageNavigator.pageNavigatorState == PageNavigatorState.NOTES_WITH_TAG 
            ? Theme.of(context).accentColor 
            : Theme.of(context).buttonColor
          ),
        title: Text(
      ...
      ListTile(
        leading: Icon(
          Icons.star, 
          color:  _pageNavigator.pageNavigatorState == PageNavigatorState.STARRED 
            ? Theme.of(context).accentColor 
            : Theme.of(context).buttonColor
        ),
        title: Text(
          AppLocalizations.of(context).translate('starred'), 
          style: TextStyle(color:  _pageNavigator.pageNavigatorState == PageNavigatorState.STARRED 
            ? Theme.of(context).accentColor 
            : Theme.of(context).accentTextTheme.display1.color
          )
        ),
      ...
      ListTile(
        leading: Icon(
          Icons.delete, color:  _pageNavigator.pageNavigatorState == PageNavigatorState.TRASH 
            ? Theme.of(context).accentColor 
            : Theme.of(context).buttonColor
        ),
        title: Text(
          AppLocalizations.of(context).translate('trash'), 
          style: TextStyle(color:  _pageNavigator.pageNavigatorState == PageNavigatorState.TRASH 
            ? Theme.of(context).accentColor 
            : Theme.of(context).accentTextTheme.display1.color
          )
        ),
